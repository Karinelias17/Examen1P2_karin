...
public class Comprador extends Usuarios{
    ...
    public Comprador(ArrayList<Videojuegos> comprado, int dinero, int cuenta, String personaje, String nombre, String usuario, String contraseña, int edad) {
